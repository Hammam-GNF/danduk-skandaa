                        ...
                        <table id="daftarhasil" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kepsek.result.rekappresensi', ['id' => $w->kelas_id]) }}" method="GET" class="d-inline" title="Detail Presensi">
                                            <button type="submit" class="btn btn-info btn-sm">
                                                <i class="bi bi-calendar-check"></i>
                                            </button>
                                        </form>

                                        <form action="{{ route('kepsek.result.rekapnilai', ['id' => $w->kelas_id]) }}" method="GET" class="d-inline" title="Detail Nilai">
                                            <button type="submit" class="btn btn-info btn-sm">
