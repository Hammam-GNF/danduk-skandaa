...
@section('content')
    ...
    <div class="container-fluid py-0 mt-4">
        ...
        {{-- <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#tambahsiswa">
            Tambah Siswa
        </button> --}}
        <!-- Modal -->
        ...
        <form action="{{ route('parenting.siswa.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex px-2 py-1">
                                                                            <div class="d-flex flex-column justify-content-center">
                                                                                <h6 class="mb-0 text-sm"> {{ $x->nis }}</h6>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex px-2 py-1">
                                                                            <div class="d-flex flex-column justify-content-center">
                                                                                <h6 class="mb-0 text-sm"> {{ $x->nama_siswa }}</h6>
                                                                            </div>
                                                                        </div>
                                                                    </td>

                                                                    <td class="align-middle-center" style="display: flex; align-items: center; justify-content: center;">
                                                                        <button type="button" class="btn btn-primary btn-sm me-2" data-toggle="tooltip" data-original-title="Edit siswa" data-bs-target="#editsiswa{{ $x->nis }}" data-bs-toggle="modal">Edit</button>

                                                                        <form method="POST" action="{{ route('siswa.update', $x->nis) }}">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <div class="modal fade" id="editsiswa{{ $x->nis }}" tabindex="-1" aria-labelledby="editsiswaLabel" aria-hidden="true">
                                                                                <div
