...
<div class="container-fluid py-0 mt-4">
    ...
    <a href="{{ route('wakel.presensi.hasilkelola', ['id_pembelajaran' => $pembelajaran->id]) }}" class="btn btn-danger">Hasil Kelola Presensi</a>
    <br>
    <div class="row">
    ...
    <div class="modal fade" id="tambahPertemuanModal" tabindex="-1" aria-labelledby="tambahPertemuanModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('wakel.presensi.store') }}" method="POST">
                    @csrf
