...
<div class="container-fluid py-0 mt-4">
    ...
    <a href="{{ route('wakel.nilai.kelola', ['id_pembelajaran' => $pembelajaran->id]) }}" class="btn btn-secondary">Kembali</a>
        ...
        <div class="container-fluid py-4">
            <div class="card shadow-lg">
                <div class="card-body">
                    ...
                    <!-- <form method="GET" action="{{ route('wakel.nilai.export', ['kelas' => $pembelajaran->kelas->id]) }}">
                        <button type="submit" class="btn btn-success mt-3"> Cetak Nilai
