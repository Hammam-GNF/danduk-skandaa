    ...
    <div class="ps ps--active-y" id="sidenav-main">
        <nav class="sidebar card py-2 mb-4">
            <ul class="nav flex-column" id="nav_accordion">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="{{ route('admin.pengguna.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu collapse ms-3">
                        <li><a class="nav-link" href="{{ route('admin.thajaran.index') }}">Data Tahun Ajaran</a></li>
                        <li><a class="nav-link" href="{{ route('admin.jurusan.index') }}">Data Jurusan</a></li>
                        <li><a class="nav-link" href="{{ route('admin.mapel.index') }}">Data Mapel</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu collapse ms-3">
                        <li><a class="nav-link" href="{{ route('admin.kelas.index') }}">Data Kelas</a></li>
                        <li><a class="nav-link" href="{{ route('admin.wakel.index') }}">Data Wali Kelas</a></li>
                        <li><a class="nav-link" href="{{ route('admin.siswa.index') }}">Data Siswa</a></li>
                        <li><a class="nav-link" href="{{ route('admin.pembelajaran.index') }}">Data Pembelajaran</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-submenu">
                    <a class="nav-link d-flex align-items-center" href="{{ route('admin.result.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2">
                            <i class="ni ni-paper-diploma text-warning text-sm opacity-10"></i>
                        </div>
