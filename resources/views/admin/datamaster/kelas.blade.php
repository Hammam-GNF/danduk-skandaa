                                                                ...
                                                                @foreach ($kelas->whereIn('kelas_tingkat', ['X', 'XI', 'XII']) as $x)
                                                                    <tr>
                                                                        ...
                                                                        <td class="align-middle-center"
                                                                            ...
                                                                            <a href="{{ route('admin.siswaperkelas.index', ['id' => $x->id]) }}"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                data-bs-target="#editkelas{{ $x->id }}"><i
                                                                                    class="bi bi-pencil"></i></button>

                                                                            <form
                                                                                action="{{ route('admin.kelas.destroy', $x->id) }}"
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-id="{{ $x->id }}"
                                                                                    data-kelas_tingkat="{{ $x->kelas_tingkat }}"
                                                                                    data-jurusan_id="{{ $x->jurusan_id }}"
                                                                                    data-rombel="{{ $x->rombel }}"
                                                                                    title="Hapus">
